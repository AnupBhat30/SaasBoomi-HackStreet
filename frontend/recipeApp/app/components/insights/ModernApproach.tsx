...
const ModernApproach: React.FC<ModernApproachProps> = ({ data }) => {
      ...
      >
        <TouchableOpacity onPress={() => toggleExpand(index)} style={styles.cardContent}>
          <View style={styles.cardHeader}>
            <MaterialCommunityIcons name={item.icon as any} size={32} color={modernColors.primary} />
            {item.badge && (
  ...
  return (
    <View style={styles.container}>
      ...
      <MotiView
        ...
        style={styles.header}
      >
        <MaterialCommunityIcons name="rocket-launch" size={40} color={modernColors.primary} />
        <Text style={styles.title}>Modern Approach</Text>
        <Text style={styles.subtitle}>Actionable tips for a healthier, energetic lifestyle</Text>
      </MotiView>
...
const styles = StyleSheet.create({
  ...
  badge: {
    backgroundColor: modernColors.accent1,
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 12,
  },
